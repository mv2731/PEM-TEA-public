# -*- coding: utf-8 -*-
"""Martinez2020_0_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1q-7i38-X-C5p5K5g4-0g2z9Az02r_M3X
"""
...
f_file = open("Martinez2020_0.csv","w")
...
#         raise Exception
    ...
    for i in range(len(Jop)):  # 60 values, increments of 0.1
        ...
        for price in df_array_dict['0.0']:  # 10.9.20 - FUTURE PRICES NEED TO BE DISCOUNTED AS WELL AS THE DISCOUNT RATE FOR THE ENERGY CHARGE?
            count += 1
            hour += 1
            if count == 1000:
                Degrade_count += 1
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_0.csv") 
df_csv
...
f_file = open("Martinez2020_1.csv","w")
print("Mean Price","Max Jop", "10 Yr Average Jop", "LCOH","INST_CAPEX", "PV_OPEX","PV_OM","PV_Costs", "PV_KG", file=f_file,sep=",")

df_LCOH_total_list_dict = {} #use to find optimalJop for each df
print("mean price 0.01")
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_1.csv") 
df_csv