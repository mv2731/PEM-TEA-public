# -*- coding: utf-8 -*-
"""Martinez2020_2_3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Dbist6l6nMUqtIJ6w_T0l0Vc6_t_ndwh
"""

#GIT - load prices
import pandas as pd
dynamic = pd.read_csv('Martinez_2020.csv')
dynamic
...
f_file = open("Martinez2020_2.csv","w")
...
#         raise Exception
    ...
    for i in range(len(Jop)):  # 60 values, increments of 0.1
        ...
        for price in df_array_dict['0.02']:  # 10.9.20 - FUTURE PRICES NEED TO BE DISCOUNTED AS WELL AS THE DISCOUNT RATE FOR THE ENERGY CHARGE?
            count += 1
            hour += 1
            if count == 1000:
                Degrade_count += 1
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_2.csv") 
df_csv
...
f_file = open("Martinez2020_3.csv","w")
print("Mean Price","Max Jop", "10 Yr Average Jop", "LCOH","INST_CAPEX", "PV_OPEX","PV_OM","PV_Costs", "PV_KG", file=f_file,sep=",")

df_LCOH_total_list_dict = {} #use to find optimalJop for each df
print("mean price 0.03")
...
#         raise Exception
    ...
    for i in range(len(Jop)):  # 60 values, increments of 0.1
        ...
        hour = 0  # first hour is 1
        Degrade_count = 0  # 10.14.20 - counts how many times degradation has been done to apply to the new voltage
        for price in df_array_dict['0.03']:  # 10.9.20 - FUTURE PRICES NEED TO BE DISCOUNTED AS WELL AS THE DISCOUNT RATE FOR THE ENERGY CHARGE?
            count += 1
            hour += 1
            if count == 1000:
                Degrade_count += 1
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_3.csv") 
df_csv