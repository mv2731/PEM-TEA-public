# -*- coding: utf-8 -*-
"""Martinez2020_6_7.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Y8hh1NGNySe3KPvF_qNDaQgt3K-t6MDS
"""
...
f_file = open("Martinez2020_6.csv","w")
...
#         raise Exception
    ...
    for i in range(len(Jop)):  # 60 values, increments of 0.1
        ...
        for price in df_array_dict['0.06']:  # 10.9.20 - FUTURE PRICES NEED TO BE DISCOUNTED AS WELL AS THE DISCOUNT RATE FOR THE ENERGY CHARGE?
            count += 1
            hour += 1
            if count == 1000:
                Degrade_count += 1
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_6.csv") 
df_csv
...
f_file = open("Martinez2020_7.csv","w")
print("Mean Price","Max Jop", "10 Yr Average Jop", "LCOH","INST_CAPEX", "PV_OPEX","PV_OM","PV_Costs", "PV_KG", file=f_file,sep=",")
...
f_file.close()
df_csv = pd.read_csv("Martinez2020_7.csv") 
df_csv